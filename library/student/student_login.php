     ...
     <div class="log_img">
         ...
         <div class="box1">
           ...
           <p style="color: white; padding-left: 10px;">
               <br><br>
               <a style="color: red; text-decoration:none;" href="update_password.php">Forgot password?</a> &nbsp &nbsp &nbsp &nbsp
               New to this website? <a style="color: azure;" href="registration.php">&nbspSing Up</a>
           </p>
        </form>
         </div>
      ...
      {
         $conut=0;
         $res=mysqli_query($conn,"SELECT * FROM `student`WHERE username='$_POST[username]' AND password='$_POST[password]';");
