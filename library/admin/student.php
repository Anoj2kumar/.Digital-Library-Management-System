...
<body>
  ...
  <div class="h"><a href="expired.php">Expired List</a></div></div>
</div>
...
function closeNav() {
  ...
  document.getElementById("main").style.marginLeft= "0";
       ...
       {
           $q=mysqli_query($conn,"SELECT first,last,username,roll,email,contact,address FROM `student` where username like '%$_POST[search]%' ");
       ...
       {
           $res=mysqli_query($conn,"SELECT first,last,username,roll,email,contact,address FROM `student`;");
           echo"<table class='table table-bordered table-hover'>";
           echo "<tr style='background-color: #6db6b9e6;'>";
              //table header
              echo "<th>"; echo "First Name"; echo" </th>";
