    ...
    <title>Books</title>
     <style type="text/css">
         ...
         body {
          ...
          transition: background-color .5px;
...
<div id="main">
  ...
  <div class="container" style="text-align: center;">
      <h2 style="color: black; font-family:lucida Console; text-align:center;">Add New Books</b></h2>
      <form class="book" action="" method="post" >
          <input type="text" name="bid" class="form-control" placeholder="Books id" required=""><br>
